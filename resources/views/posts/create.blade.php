...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 px-10 bg-white p-10 rounded-lg shadow-xl mt-10 mt:md-0">
            <form action="{{route('post.store')}}" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="titulo" class="mb-2 block uppercase text-gray-500">
                        Titulo
                    </label>
                    <input type="text" 
                            id="titulo" 
                ...
                <div class="mb-5">
                    <label for="descripcion" class="mb-2 block uppercase text-gray-500">
                        Descripción
                    </label>
                    <textarea type="" 
                            id="descripcion" 
                            ...
                            class="border p-3 w-full rounded-lg @error('titulo')
                            border-red-500
                            @enderror" value="">{{old('descripcion')}}</textarea>
